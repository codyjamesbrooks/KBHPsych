...
%o`, message, error2, detail);
  ...
  // frontend/javascript/controllers/openable_controller.js
  var openable_controller_exports = {};
  __export(openable_controller_exports, {
    default: () => openable_controller_default
  });
  var openable_controller_default = class extends Controller {
    connect() {
      this.events = [];
      this.listeners = [];
  ...
  __publicField(openable_controller_default, "classes", ["open"]);
  __publicField(openable_controller_default, "values", {
    closeMethods: Array
  });

  // import-glob:./controllers/**/*.{js,js.rb}
  var modules = {
    "./controllers/openable_controller.js": openable_controller_exports
  };
...
//# sourceMappingURL=/_bridgetown/static/index.WK7FJE65.js.map
